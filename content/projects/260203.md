---
title: Tumult
subtitle: A Matrix client inspired by Discord
description: "Creating a functional replacement for Discord that operates on the Matrix protocol, due to the growing community unease with Discord and their business practices."
buttonColor: rgb(251, 143, 92)
backgroundColor: rgb(0, 82, 93)
status: in-progress
---
